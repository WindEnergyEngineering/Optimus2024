...
wind_directory = r'C:\Users\carlo\Documents\GitHub\Optimus2024\IEA-3.4-130-RWT\Wind\DLC51_NTM_Vr+-2&25'  # Update this path to the actual location
#hydrodyn_directory = '../Wave'  # Update this path to the actual location
main_directory = r'C:\Users\carlo\Documents\GitHub\Optimus2024\IEA-3.4-130-RWT\Optimus_HH140_D178\DLC_5_1'  # Update this path
second_directory = r'C:\Users\carlo\Documents\GitHub\Optimus2024\IEA-3.4-130-RWT\Optimus_HH140_D178'
...
for wind_file in wind_files:
    ...
    next_wind_speed = float(wind_file.split('_')[0][1:])
    ...
    dlc_directory = os.path.join(output_directory, 'DLC51')
