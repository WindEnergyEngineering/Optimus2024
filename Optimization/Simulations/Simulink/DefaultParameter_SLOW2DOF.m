...
Parameter.Turbine.r_GB              = 53.37;            % [-]       gearbox ratio, from ElastoDyn.dat:1/GBRatio, from Shakti(german) 20/11/24 fle 
Parameter.Turbine.R              	= 178/2;            % [m]       Rotor radius, from ElastoDyn.dat: TipRad, from Shakti(Carlo table) 20/11/24 fle  

% drive-train dynamics
J_G                               	= 782.44;                % [kgm^2]	Generator Inertia About High-Speed Shaft, from ElastoDyn.dat: GenIner (shakti 29.11 DLC 1.2 FAST, JP)
J_R                                	= 98167088;         % [kgm^2]	Rotor Inertia About High-Speed Shaft, from ED.sum file (shakti 03.12 from sum file way too high 17 times higher than 3.4, assmumed double of 3.4 model, JP)
...
%% Generator
Parameter.Generator.eta_el      	= 0.986;             % [-]       Generator efficiency, from ServoDyn.dat: GenEff
