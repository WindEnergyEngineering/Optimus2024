...
%% Torque Controller
Parameter.VSC.kp                        = 27789.516413;                             % [Nm/(rad/s)]  % proportional gain, first guess (adjusted shakti 10.12 task design script with generator inertia, JP)
Parameter.VSC.Ti                        = 2.195555;                              % [s]           % integral gain, first guess (adjusted shakti 10.12 task design script with generator inertia, JP)
