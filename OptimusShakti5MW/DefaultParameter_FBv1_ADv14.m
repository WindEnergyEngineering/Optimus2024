...
Parameter.VSC.k                         = 42.6;                             % [Nm/(rad/s)^2] % brute-force-optimized (fle)
...
Parameter.VSC.Delta_P                   = 4.9e6;                          	% [W]       % change of power at which over-speed limit should be reached, brute-force-optimized
