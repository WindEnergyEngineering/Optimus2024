...
Parameter.Turbine.r_GB              = 53.25;            % [-]       gearbox ratio, from ElastoDyn.dat:1/GBRatio, from Shakti(german) 20/11/24 fle 
Parameter.Turbine.R              	= 178/2;            % [m]       Rotor radius, from ElastoDyn.dat: TipRad, from Shakti(Carlo table) 20/11/24 fle  

% drive-train dynamics
J_G                               	= 534.116;              % [kgm^2]	Generator Inertia About High-Speed Shaft, from ElastoDyn.dat: GenIner (shakti 29.11 DLC 1.2 FAST)
J_R                                	= 595753984;         % [kgm^2]	Rotor Inertia About High-Speed Shaft, from ED.sum file (shakti 29.11 DLC 1.2 FAST)
...
Parameter.Turbine.HubHeight         = 140.4374;           % [m]       TowerHt+Twr2Shft+OverHang*sind(ShftTilt) (shakti 29.11 DLC 1.2 FAST)
