...
J_G                               	= 860;              % [kgm^2]	Generator Inertia About High-Speed Shaft, from ElastoDyn.dat: GenIner (shakti 29.11 DLC 1.2 FAST, JP)
...
%% Generator
Parameter.Generator.eta_el      	= 0.9659;             % [-]       Generator efficiency, from ServoDyn.dat: GenEff
